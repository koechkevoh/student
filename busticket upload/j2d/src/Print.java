...
public class Print extends JFrame{
		...
		panel.add(new JLabel("Source place----- "+ConfirmSeat.sou));
		panel.add(new JLabel("Destination place-----  "+ConfirmSeat.des));
		...
		panel.add(new JLabel("Bus deperature time----- "+ConfirmSeat.deptime));
